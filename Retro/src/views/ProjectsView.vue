...
.nearby-text { grid-area: 1 / 1 / 2 / 2; }
.nearby-image { grid-area: 1 / 2 / 2 / 3; }
.milestone-image { grid-area: 2 / 1 / 3 / 2; }
.milestone-text { grid-area: 2 / 2 / 3 / 3; }
.ebb-text { grid-area: 3 / 1 / 4 / 2; }
.ebb-image { grid-area: 3 / 2 / 4 / 3; }
